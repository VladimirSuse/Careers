...
class Employer extends SyncObject{
	...
	*/
	public function updateEmployer($data, $employerID){
		return $this->mysql_binding_update($data, $employerID, 'career_employers');
	}
	...
	*/
	...
	/**
	*	Delete a selected direct contact information
	*   @param int $id an id represent a service 
	*	@return a boolean true on success, else error message
	*/
	public function removeService($id){
		return $this->mysql_query("DELETE FROM career_employer_services WHERE id = $id");
	}
	...
	*/
	public function getEventRegistrationEmployer($id=NULL){
	...
	*	@return an array of event registration with service/s and employer info 
	*/
	public function getEventRegistrationEvent($id=NULL){
		return $this->mysql_query("SELECT * FROM career_employer_event_registrations emr
			JOIN career_employers em ON emr.career_employer_id = em.id
			JOIN career_employer_events e ON emr.career_employer_event_id = e.id
			...
			".(isset($id) ? " WHERE emr.career_event_id = '$id'" : ''));
	}
	...
	*/
	...
	/**
	*	Get all contacts for an employer that aren't aready used 
	*	@param int $id an id represent an employer
	*	@return an array of direct contact
	*/
	...
	*	@return a boolean true on success, else error message
	*/
	public function removeDirectContact($id){
		return $this->mysql_query("DELETE FROM career_employer_direct_contacts WHERE career_employer_contact_id = $id");
	}

	/*
	*	Delete a selected billing contact information
	* @param int $id an id represent a billing contact 
	*	@return a boolean true on success, else error message
	*/
	public function removeBillingContact($id){
		return $this->mysql_query("DELETE FROM career_employer_billing_contacts WHERE career_employer_contact_id = $id");
	}

	/*
	*	Delete a selected event contact information
	* @param int $id an id represent a event contact 
	*	@return a boolean true on success, else error message
	*/
	public function removeEventContact($id){
		return $this->mysql_query("DELETE FROM career_employer_event_contacts WHERE career_employer_contact_id = $id");
	}

	/*
	*	Get contact detail from table career_employer_contact details
	* @param int $id an id represent a contact 
	*	@return an array of contact details, else error message
	*/
	public function getContactDetail($id=NULL){
		return $this->mysql_query("SELECT * FROM career_employer_contact_details ".(isset($id) ? " WHERE id = '$id'" : ''));
	}
