<div class="row">
	...
	<div class="nine columns" id="contact-column" style="padding:1em;border:solid #C7E3FF 1px">
		<div class="loader" id="contact-form-loader"><img src="../../img/loader.gif"></div>
		<div class="section-title" id="cd-title">Contact Details</div>
		<div class="section-title" id="toc-title">Table of Contacts</div>
		<div class="section-title" id="anc-title">Add New Contact</div>
		...
		<div class="row" id="new-form">
			<form id="contact_form" action="post">		
				...
				<div class="row">
			       	<div class="ten columns labels" style="margin-bottom:2.05em">
